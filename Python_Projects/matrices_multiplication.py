def multiplier_matrices_carrees(matrice1, matrice2):
    # Vérifier que les matrices sont carrées (ordre 3x3)
...
matrice_resultante = multiplier_matrices_carrees(matrice_A, matrice_B)
